...
from .mpn import MPN
from .mpnrxn import RXNMPN
from .ffn import build_ffn, MultiReadout
from chemprop.args import TrainArgs
from chemprop.features import BatchMolGraph, BatchReactionGraph
...
class MoleculeModel(nn.Module):
    ...
    def create_encoder(self, args: TrainArgs) -> None:
        ...
        :param args: A :class:`~chemprop.args.TrainArgs` object containing model arguments.
        """
        if args.react_prod_cross_attention:
            self.encoder = RXNMPN(args)
        else:
    ...
    def create_ffn(self, args: TrainArgs) -> None:
        ...
        if args.atom_descriptors == "descriptor":
            ...
            if args.dual_react_prod_model in ['reac_prod', 'reac_diff', 'prod_diff'] and args.react_prod_cross_attention:
                if args.features_size is not None:
                    # atom_first_linear_dim = first_linear_dim * 2 - args.features_size
                    atom_first_linear_dim = first_linear_dim
                else:
                    # atom_first_linear_dim = first_linear_dim * 2
                    atom_first_linear_dim = first_linear_dim
            else:
                atom_first_linear_dim = first_linear_dim
    ...
    def fingerprint(
        ...
        batch: Union[
            ...
            Union[List[BatchMolGraph], List[BatchReactionGraph]],
        ],
