...
def get_data(path: str,
    ...
    with open(path) as f:
        ...
        # determine whether to use reactants-products attention
        individual_react_prod_mol = args.react_prod_cross_attention
        ...
        data = MoleculeDataset([
            MoleculeDatapoint(
                ...
                individual_react_prod_mol=individual_react_prod_mol
