...
from chemprop.features import BatchMolGraph, MolGraph, BatchReactionGraph, ReactionGraph
...
class MoleculeDatapoint:
    ...
    def __init__(self,
                 ...
                 individual_react_prod_mol: bool = False):
        """
        ...
        self.individual_react_prod_mol = individual_react_prod_mol
            ...
            for d in self._data:
                ...
                for s, m in zip(d.smiles, d.mol):
                    if s in SMILES_TO_GRAPH:
                        ...
                        if not d.individual_react_prod_mol:
...
def make_mols(smiles: List[str], reaction_list: List[bool], keep_h_list: List[bool],
              add_h_list: List[bool], keep_atom_map_list: List[bool]):
    """
