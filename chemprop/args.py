...
class TrainArgs(CommonArgs):
    ...
    """
    react_prod_cross_attention: bool = False
    """
    Use reactant molecule and product molecule atom attention
    """
    dual_react_prod_model: Literal['reac_prod', 'reac_diff', 'prod_diff', 'diff'] = 'reac_diff'
    """
    Use react product model
    """
